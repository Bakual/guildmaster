...
CREATE TABLE `#__guildmaster_conf`
(
    `id`                INT(10) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `#__guildmaster_conf` (guild_name, guild_id, guild_rank_1, guild_rank_2, guild_rank_3, guild_rank_4,
                                   guild_rank_5, guild_rank_6, guild_rank_7, guild_rank_8, show_updated, popup,
                                   use_images, show_lastnames, roster_url, roster_url_xml, guild_url, cache_time,
                                   guild_info)
values ('Atrocitas', 1699210, 'Gruender', 'Botschafter', 'Sekraeter', 'Berater', 'Veteran', 'Mitglied', 'Anwaerter',
        'Frischling', 1, 1, 1, 1, 'http://eq2players.station.sony.com/en/guild_profile.vm',
        'http://eq2players.station.sony.com/guilds/guild_roster_xml.vm',
        'http://eq2players.station.sony.com/guilds/guild_profile.vm', 86400, 0);
